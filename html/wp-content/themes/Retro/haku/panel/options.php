...
<div class="section haku_options" data-tab="<?php _e('Portfolio', 'haku'); ?>">
	...
	<div class="haku_optgroup clearfix">
		...
		<div>
			...
			<!-- Slider -->
			<div class="haku_slider" data-min="0" data-max="<?php echo get_posts_count(); ?>" data-step="1"></div>
...
<div class="section haku_options" data-tab="<?php _e('Blog', 'haku'); ?>">
	...
	<div class="haku_optgroup clearfix">
		...
		<div>
			...
			<!-- Slider -->
			<div class="haku_slider" data-min="0" data-max="<?php echo get_posts_count('post'); ?>" data-step="1"></div>
...
<div class="section haku_sidebars haku_manager" data-tab="<?php _e('Sidebars', 'haku'); ?>">
	...
	<!-- Option notice -->
	<span class="haku_notice"><?php _e('You can assign a different Sidebar to each page choosing your Sidebar under the "Page Attributes" Box when in the edit mode.', 'haku'); ?></span>
